...
| **v1.5** | ✅ **已发布** | **2026-02-20** | **实时监控与自动化（85%）** |
| v1.6 | 📋 计划中 | 2026-03-05 | 多项目仪表盘 + 操作历史 |
| v1.7 | 📋 计划中 | 2026-03-20 | 文件与命令管理 |
